...
export default function EventForm({
  ...
  return (
    ...
    >
      ...
      <div>
        <label htmlFor="event-date" className="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wider">
          Date & Time
        </label>
        <div className="relative">
      ...
      <div className="flex gap-2 pt-2">
        ...
        <button
          type="submit"
          className={`flex-[2] text-white font-semibold py-2 rounded-xl text-sm transition-colors shadow-sm ${
